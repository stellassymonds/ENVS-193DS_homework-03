...
a. 
```{r}
#| label: continuous-predictor-visual ADD SUBTITLE 
...
ggplot(data = wind_speed_and_duration,
  ...
  scale_color_manual(values = c("wind_speed_and_duration" = "darkblue")) + 
    # rename x and y axes, add descriptive title
...
```{r}
#| label: categorical-predictor-visual ADD SUBTITLE
...
ggplot(data = plans_and_duration,
  ...
  # relabelling x- and y-axes, adding descriptive title
